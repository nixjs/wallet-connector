...
export class Helpers {
  ...
  static isHex(value: any): boolean {
    return (
      typeof value === "string" &&
      !Number.isNaN(parseInt(value, 16)) &&
  ...
  static isString(value: any): boolean {
    ...
    return (
      typeof value === "string" ||
      (typeof value === "object" && value.constructor === String)
    );
  }
  ...
  static isTronInstalled(): boolean {
    if (
      window &&
      Object.prototype.hasOwnProperty.call(window, PLATFORM_CONTEXT.TRONWEB)
    ) {
      return true;
    }
    return false;
  ...
  static isBinanceInstalled(): boolean {
    if (
      ...
      Object.prototype.hasOwnProperty.call(
        window,
        PLATFORM_CONTEXT.BINANCE_CHAIN
      )
    ) {
      return true;
    }
  ...
  static isMetaMaskInstalled(): boolean {
    if (
      window &&
      Object.prototype.hasOwnProperty.call(window, PLATFORM_CONTEXT.ETHEREUM)
    ) {
      return true;
    }
    return false;
  ...
  static hasProperties(obj: object, properties: string[]): boolean {
    return !!(
      properties.length &&
      !properties
        .map((property: string): boolean => this.hasProperty(obj, property))
        .includes(false)
    );
  }
  ...
  static hasWalletCtx(context: any): boolean {
    return !!(
      Object.prototype.hasOwnProperty.call(window, context) && window[context]
    );
  }
  ...
  static fromHexParser(value: Numberish, dec = 18): HexParser {
